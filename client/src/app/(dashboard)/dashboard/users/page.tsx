...
export default function UsersPage() {
  ...
  return (
    <div className="md:p-8 dark:bg-gray-900 dark:text-white min-h-screen transition-colors">
      <h1 className="text-3xl font-bold mb-6 text-gray-800 dark:text-white">
        User Management
      </h1>
      <div className="mx-auto p-4 bg-gray-50 dark:bg-gray-800 rounded-lg shadow-lg transition-colors">
        <div className="mb-6 flex flex-col md:flex-row md:items-center md:justify-between gap-4">
          <input
            type="text"
            placeholder="Search users..."
            className="w-full md:w-1/3 p-2 border rounded-lg focus:outline-none focus:ring-2 focus:ring-blue-500 dark:bg-gray-700 dark:border-gray-600 dark:text-white"
            value={searchTerm}
            onChange={(e) => setSearchTerm(e.target.value)}
          />
          <div className="flex gap-4">
        ...
        />
        <div className="mt-6 flex flex-col sm:flex-row justify-between items-center">
          <div className="mb-4 sm:mb-0 text-sm text-gray-600 dark:text-gray-300">
            Showing {indexOfFirstUser + 1} to{" "}
            {Math.min(indexOfLastUser, filteredUsers.length)} of{" "}
            {filteredUsers.length} entries
          </div>
              ...
              (pageNumber) => (
                <button
                  ...
                  className={`px-3 py-1 rounded-md text-sm font-medium ${
                    currentPage === pageNumber
                      ? "bg-blue-500 text-white"
                      : "bg-white text-blue-500 hover:bg-blue-100 dark:bg-gray-700 dark:text-blue-300 dark:hover:bg-gray-600"
                  } transition duration-300 ease-in-out`}
                >
                  {pageNumber}
                </button>
