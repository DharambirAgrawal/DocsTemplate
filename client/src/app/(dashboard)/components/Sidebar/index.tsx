      ...
      menuItems: [
        ...
        },
        {
          ...
          children: [
            {
              label: "Gallery",
              route: "/dashboard/images/gallery",
              role: ["AUTHOR", "ADMIN"],
            },
            {
              label: "Upload",
        ...
        },
        {
          ...
          children: [
            {
              label: "View",
              route: "/dashboard/course/view",
              role: ["AUTHOR", "ADMIN"],
            },
            {
              label: "Upload",
              route: "/dashboard/course/upload",
              role: ["AUTHOR", "ADMIN"],
            },
          ],
        },
...

        {
          ...
          route: "#",
          children: [
            { label: "Tables", route: "/dashboard/tables", role: ["ADMIN"] },
          ],
        },
      ],
    },
