...
import SidebarItem from "@/app/(adminDashboard)/components/Sidebar/SidebarItem";
...
const menuGroups = [
  {
    ...
    menuItems: [
      ...
      },
      {
        ...
        route: "#",
        children: [
          { label: "Settings", route: "/admin/pages/settings" },
        ],
      },
    ],
  },
    ...
    menuItems: [
      {
        ...
        route: "#",
        children: [
          { label: "Basic Chart", route: "/admin/charts/basic-chart" },
        ],
      },
    ],
  },
