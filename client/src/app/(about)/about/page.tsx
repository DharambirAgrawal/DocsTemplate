      ...
      <div className="max-w-4xl mx-auto">
        ...
        <div className="bg-white rounded-lg shadow-xl p-8 transition-all duration-500 ease-in-out">
          <p className="text-lg leading-relaxed text-gray-700">
            {content[activeTab as keyof Content]}
          </p>
        </div>
        {activeTab === "team" && (
        ...
        <div className="mt-12 grid grid-cols-1 md:grid-cols-3 gap-8">
          {[
            ...
            <div
              key={stat.title}
              className="bg-blue-600 text-white p-6 rounded-lg shadow-md hover:shadow-xl transition-all duration-300 transform hover:-translate-y-1"
            >
