...
import { termsAndConditionsMetadata } from "../metaData";
    ...
    <div className="container mx-auto px-4 py-16">
      ...
      <div className="max-w-4xl mx-auto">
        <p className="text-lg mb-8 text-center text-gray-600">
          Welcome to Course & Blog. By using our website and services, you agree
        ...
        <div className="space-y-4">
          {sections.map((section) => (
            ...
            >
              <summary className="px-6 py-4 cursor-pointer hover:bg-gray-50 transition-colors duration-300 flex justify-between items-center">
